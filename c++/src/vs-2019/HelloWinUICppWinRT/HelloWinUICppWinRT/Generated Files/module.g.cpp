...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"HelloWinUICppWinRT.MainPage"))
    {
        return winrt_make_HelloWinUICppWinRT_MainPage();
    }

    if (requal(name, L"HelloWinUICppWinRT.XamlMetaDataProvider"))
    {
        return winrt_make_HelloWinUICppWinRT_XamlMetaDataProvider();
    }
