...
{
    struct __declspec(empty_bases) XamlControlsXamlMetaDataProvider : Windows::UI::Xaml::Markup::IXamlMetadataProvider,
        impl::require<XamlControlsXamlMetaDataProvider, Microsoft::UI::Xaml::XamlTypeInfo::IXamlControlsXamlMetaDataProvider>
    {
        ...
        XamlControlsXamlMetaDataProvider(void* ptr, take_ownership_from_abi_t) noexcept : Windows::UI::Xaml::Markup::IXamlMetadataProvider(ptr, take_ownership_from_abi) {}
